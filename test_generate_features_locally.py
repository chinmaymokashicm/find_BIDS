...
dataset_info: dict[str, dict] = {
    "PROACTIVE": {
        "dicom_root": UPath("/Volumes/NeuroCare/PROACTIVE/xnat"),
        "features_root": UPath("/Volumes/csi/Quarles_Lab/find_BIDS/features/PROACTIVE"),
        "subject_level": True,
        "session_subdir_path": "",
        "series_subdir_path": "DICOM/"
    },
    "QIAC": {
        "dicom_root": UPath("/Volumes/csi/Quarles_Lab/Bajaj_Projects/Melanoma_Data_QIAC/Raw_MRI"),
        "features_root": UPath("/Volumes/csi/Quarles_Lab/find_BIDS/features/QIAC"),
        "subject_level": False,
